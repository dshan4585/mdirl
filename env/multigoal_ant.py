...
class MultiGoalAntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,
                 xml_file='ant.xml',
    ...
    def step(self, action):
        ...
        d_before = norm(xy_position_before - self.gs[self.idx])
        d_after = norm(xy_position_after - self.gs[self.idx])
